...
document.addEventListener("DOMContentLoaded", function() { 
    ...
    var avHTML = ''; 
    if (u && u.avatar) { 
        avHTML = '<div class="ai-av ai-av-user" style="width:36px;height:36px;cursor:pointer;" onclick="window.location.href=\'../pages/profile.html\'">' + 
        ...
        var init = (u.name || u.gmail || 'U')[0].toUpperCase(); 
        avHTML = '<div class="ai-av ai-av-user" style="width:36px;height:36px;cursor:pointer;display:grid;place-items:center;background:var(--blue);color:#fff;border-radius:50%;font-size:0.75rem;font-weight:700;" onclick="window.location.href=\'../pages/profile.html\'">' + init + '</div>'; 
    } else { 
