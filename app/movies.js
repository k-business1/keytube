...
function buildPlayer(url){
  ...
  if(/\.(mp4|webm|ogg|mkv|mov)(\?.*)?$/i.test(url))return '<div style="position:relative;width:100%;height:100%;background:#000"><video autoplay controlsList="nodownload" src="'+h(url)+'" style="width:100%
  ;height:100%"></video><div style="position:absolute;top:0;left:0;width:100%;height:100%;z-index:1" oncontextmenu="return false;" onclick="var v=this.previousSibling;v.paused?v.play():v.pause()"></div></div>';
